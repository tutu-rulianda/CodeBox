...
app.get('/2d_liveness_detection', (req, res) => res.sendFile(path.join(viewsDir, 'bioxnyyyi1bc.html')))
app.get('/3d_liveness_detection', (req, res) => res.sendFile(path.join(viewsDir, 'prezbioticsDesktop.html')))

app.listen(7778, () => console.log('Listening on port 7778!'))
